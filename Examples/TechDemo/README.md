...
| **Input System** | A/D walk, Space jump, Shift dash, hold a wall to climb, Space/Enter confirm, ESC to quit — all via named actions |
...
| **Custom Components** | `PlayerController` (walk/jump/coyote/dash/wall), `Collectible`, `FloatMotion`, `EnemyAI` |
| **Custom Systems** | `sPlayerMovement` (gravity, jump, dash, wall climb, floor), `sCollectibles`, `sFloatMotion`, `sEnemyAI` |
